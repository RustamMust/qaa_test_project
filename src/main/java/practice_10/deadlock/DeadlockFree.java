    ...
    public static void main(String[] args) {
        Thread t1 = new Thread(() -> {
            synchronized (firstFile) {
                System.out.println("Поток 1 захватил файл 1.txt");
                ...
                synchronized (secondFile) {
                    System.out.println("Поток 1 захватил файл 2.txt");
                }
            }
        });
        ...
        Thread t2 = new Thread(() -> {
            synchronized (firstFile) {
                System.out.println("Поток 2 захватил файл 1.txt");
                ...
                synchronized (secondFile) {
                    System.out.println("Поток 2 захватил файл 2.txt");
                }
            }
        });
